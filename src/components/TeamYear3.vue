            ...
            return {
                ...
                cards: [
                    { 
                        ...
                        flex: 6, 
                        linkedin: "https://www.linkedin.com/in/anna_biolchini", 
                    ...
                    },
                    {
                        ...
                        flex: 6, 
                        resume: '../assets/year3/resumes/elaine_smith.pdf', 
                    ...
                    { 
                        title: 'Aironas Belevicius',
                        src: require('../assets/year3/headshots/aironas_bilevicius.jpg'),
                        flex: 6,
                        resume: '../assets/year3/resumes/aironas_belevicius.pdf',
                        linkedin: "https://www.linkedin.com/in/aironasbilevicius",
                        email: 'aironas@colostate.edu',
                        text: "I am a senior in Electrical Engineering. I am currently interested in power systems, but I am open to exploring all of the different fields that Electrical Engineering has to offer. Some activities that I like to do outside of school are going to the gym, playing video games, building Lego, and having a good social life."
                    },
                    {
                        title: 'Samuel Peccoud',
                        src: require('../assets/year3/headshots/samuel_peccoud.jpeg'),
                        flex: 6,
                        resume: '../assets/year3/resumes/samuel_peccoud.pdf',
                        linkedin: "https://www.linkedin.com/in/samuel-peccoud",
                        email: 'speccoud@colostate.edu',
                        text: "Hey there! I'm Samuel, a senior in Computer Engineering with a minor in Machine Learning. You can often catch me in the digital trenches, comparing ML models and diving into the world of algorithms and code. But when my computer screen dims, I head to the local climbing gym to send boulder problems and routes. Whether it's debugging code or navigating a climbing route, I love a good challenge."
                    },
                    {
                        title: 'Kaitlin Rentmeester',
                        src: require('../assets/year3/headshots/kaitlin_rentmeester.jpg'),
                        flex: 6,
                        linkedin: "https://www.linkedin.com/in/kaitlin-rentmeester-180033233",
                    ...
                    //Lawrence will go here
                    {
                        title: 'Jacob Beauchamp',
                        src: require('../assets/year3/headshots/jacob_beauchamp.png'),
                        flex: 6,
                        resume: '../assets/year3/resumes/jacob_beauchamp.pdf',
                        linkedin: "https://www.linkedin.com/in/jacob-beauchamp-2002",
                    ...
                    },
                    {
                        ...
                        flex: 6,
                        resume: '../assets/year3/resumes/caleb_costigan.pdf',
                ...
                VIPS: [
                    ...
                    { 
                        title: 'Joey Reback', 
                        src: require('../assets/headshots/year3/joey_reback.jpg'), 
                        flex: 6, 
                    ...
                    },
                    {
                        ...
                        src: require('../assets/headshots/year3/mckenzy_johnson.png'),
                        flex: 6,
                        resume: '../assets/year3/resumes/mckenzy_johnson.pdf',
                        linkedin: "https://www.linkedin.com/in/mckenzy-johnson-2881751a5",
                        email: 'mckenzypaige@gmail.com',
                        text: "I am a junior in Computer Engineering with a minor in Machine Learning. I am interested in pursuing a career in embedded systems and integrating AI to improve and develop effective airborne and defense technology. In my free time, I enjoy hiking, spearfishing, soccer, snowboarding, and generally being outdoors."
                    },
